...
| Drum       | Articulation           | MIDI Note - Spark | MIDI Note - White | Midi Note Studio Stadium | Dorico  Instrument | Dorico playing technique | Dorico notehea | Dorico example |
| ------------- |-------------| -----| ---- | --- | ------------- | ------------- | ------------- | ------------- |
...
| | Open Pedal | 70 | % | % | Hi-hat (pedal) | Open 2 | ![image-20200803090108032](README.assets/image-20200803090108032.png) | ![image-20200723154353499](README.assets/image-20200723154353499.png) |
